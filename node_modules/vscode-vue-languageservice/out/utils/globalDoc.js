...
exports.createGlobalDefineDocument = void 0;
...
function createGlobalDefineDocument(root, lsType) {
    let code = `
...
`;
    return vscode_languageserver_textdocument_1.TextDocument.create(shared.fsPathToUri((0, upath_1.join)(root, '__VLS_globals.ts')), 'typescript', 0, code);
}
exports.createGlobalDefineDocument = createGlobalDefineDocument;
...
//# sourceMappingURL=globalDoc.js.map