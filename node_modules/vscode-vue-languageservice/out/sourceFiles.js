...
function createSourceFiles() {
    ...
    return {
        ...
        toTsLocations: (0, untrack_1.untrack)(function* (uri, start, end) {
            if (end === undefined)
                end = start;
        ...
        fromTsLocation: (0, untrack_1.untrack)(function* (lsType, uri, start, end) {
            if (end === undefined)
                end = start;
        ...
        fromTsLocation2: (0, untrack_1.untrack)(function* (lsType, uri, start, end) {
            if (end === undefined)
                end = start;
            const sourceMap = tsRefs[lsType].sourceMaps.value.get(uri);
            if (sourceMap) {
