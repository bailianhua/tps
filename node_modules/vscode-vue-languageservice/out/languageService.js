...
function getDocumentLanguageService(modules, getPreferences, getFormatOptions, formatters) {
    ...
    function getVueDocument(document) {
        ...
        const vueDoc = (0, sourceFile_1.createSourceFile)(document.uri, document.getText(), document.version.toString(), context);
...
function createLanguageService(modules, vueHost, isTsPlugin = false) {
    ...
    function publicApiHook(api, shouldUpdateTemplateScript = true, blockNewRequest = true) {
        const handler = {
    ...
    function update(shouldUpdateTemplateScript) {
        var _a, _b;
        const newVueProjectVersion = (_a = vueHost.getVueProjectVersion) === null || _a === void 0 ? void 0 : _a.call(vueHost);
        if (newVueProjectVersion === undefined || newVueProjectVersion !== vueProjectVersion) {
            ...
            for (const sourceFile of sourceFiles.getAll()) {
                ...
                if (!newFileUris.has(sourceFile.uri) && !((_b = vueHost.fileExists) === null || _b === void 0 ? void 0 : _b.call(vueHost, fileName))) {
                    // delete
    ...
    function createTsLsHost(lsType) {
        ...
        const tsHost = {
            ...
            getProjectVersion: () => {
                var _a;
                return ((_a = vueHost.getProjectVersion) === null || _a === void 0 ? void 0 : _a.call(vueHost)) + '-' + (lsType === 'template' ? templateProjectVersion : scriptProjectVersion).toString();
            },
            getScriptFileNames,
            getScriptVersion,
            getScriptSnapshot,
    ...
    function updateSourceFiles(uris, shouldUpdateTemplateScript) {
        ...
        for (const uri of uris) {
            ...
            if (!doc)
                continue;
            if (!sourceFile) {
                sourceFiles.set(uri, (0, sourceFile_1.createSourceFile)(doc.uri, doc.getText(), doc.version.toString(), context));
